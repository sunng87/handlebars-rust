...
impl<'rc> fmt::Debug for RenderContext<'rc> {
...
fn call_helper_for_value<'reg, 'rc: 'reg>(
    hd: &'reg Box<HelperDef>,
    ht: &'reg Helper<'reg, 'rc>,
    registry: &'reg Registry,
    rc: &'rc mut RenderContext<'rc>,
